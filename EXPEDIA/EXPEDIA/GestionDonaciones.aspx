                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="tab-pane fade in active" id="Ingresar">
                                        ...
                                        <label  for="numero" >Número de Placa / Serie </label>
                                          <asp:TextBox ValidationGroup="one" runat="server" ID="numero" data-toggle="tooltip" MaxLength="10" data-placement="right" ToolTip="Este espacio debe proporcionar el número de placa o de serie del activo que desea consultar." />
                                        ...
                                        <asp:ListItem Value="0">Todos</asp:ListItem>
                                            ...
                                            <div runat="server" id="theDiv"  >
                                                ...
                                                <asp:RequiredFieldValidator ValidationGroup="one" ID="vFinalizacon" runat="server"   ControlToValidate="Fecha_entrega" ForeColor="Red" SetFocusOnError="True" ErrorMessage="&lt;b&gt;*&lt;/b&gt;"></asp:RequiredFieldValidator>
                                                     <asp:CompareValidator Type="Date" ID="CompareValidator1"   Display="Dynamic" runat="server" ControlToValidate="Fecha_entrega" Operator="GreaterThanEqual" ValueToCompare="<%#  DateTime.Now.ToShortDateString() %>"  ForeColor="Red" SetFocusOnError="true" ErrorMessage="No se puede escoger una fecha menor a la del día de hoy."></asp:CompareValidator>
                                                ...
                                                <div class="pure-control-group" >
                                                    ...
                                                    <asp:TextBox ValidationGroup="one" runat="server" ID="cedula_usuario"  AutoPostBack="True" OnTextChanged="cedula_usuario_TextChanged" data-toggle="tooltip" data-placement="right" title="En este espacio se debe proporcionar el número de cedula de la persona a entregar la donación omita guiones, no excluya ningún digito del documento, este espacio es requerido."  placeholder="#-####-####" />
                                    ...
                                    <asp:Panel ID="Panel1" runat="server">
                                        <div class="tab-pane" id="Consultar">
                                            ...
                                            <asp:Panel ID="Panel3" runat="server">
                                                ...
                                                <asp:TextBox runat="server" ValidationGroup="two"   data-toggle="tooltip" data-placement="right"     ToolTip="Por favor, Ingrese el número de la donación a consultar" ID="id_prestamo" />
