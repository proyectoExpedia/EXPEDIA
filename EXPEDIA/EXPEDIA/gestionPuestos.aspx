<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionPuestos.aspx.cs" Inherits="EXPEDIA.gestionPuestos" %>
                                                ...
                                                <div class="form-group pull-right"><label>Buscar:  </label></div>
                                                    <asp:Table ID="Table2" runat="server" CssClass="table table-hover table-bordered results">
                                                         <asp:TableHeaderRow runat="server">
                                                                ...
                                                                <asp:TableHeaderCell ColumnSpan="1">Ocupación</asp:TableHeaderCell>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            <div class="span">
                                                <asp:Button runat="server" ValidationGroup="Six" CssClass="btn btn-primary" OnClick="Btn_modificar_ocupaciones_Click" ID="Button1" Text="Modificar ocupación" />
...
<%--            </ContentTemplate>
     ...
     <script type="text/javascript">
         function modificar(id) {
             ...
             document.getElementById('mIdOcu').value = ida;
             document.getElementById('mIdOcuO').value = ida;
             document.getElementById('mDescripcion').value = descripcion;
             document.getElementById("mIdOcuO").style.visibility = "hidden";
         }
