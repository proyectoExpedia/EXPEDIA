<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionTipoActivos.aspx.cs" Inherits="EXPEDIA.gestionTipoActivos" %>
       ...
       <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Gestión de descripción de activos</h3>
                        <div>
                    ...
                    <div class="panel-body">
                        <asp:TabContainer ID="TabContainer1" CssClass="nav nav-tabs" runat="server" ActiveTabIndex="0">
                            <asp:TabPanel runat="server" HeaderText="<span style='margin: 5px' data-toggle='tab'><b>Registro de descripción</b><span style='margin: 10px' class='glyphicon glyphicon-plus-sign'></span></span>" ID="TabPanel1">
                                <ContentTemplate>
                                    <asp:Panel runat="server" DefaultButton="Registar_Descripcion_Ac" ID="panel2"> 
                            ...
                            <asp:TabPanel runat="server" HeaderText="<span style='margin: 5px'  data-toggle='tab'><b>Control de descripción</b> <span style='margin: 10px'  class='glyphicon glyphicon-question-sign'></span><span class='glyphicon glyphicon-minus-sign'></span><span class='glyphicon glyphicon-ok-sign'></span></span>" ID="TabPanel2">
                                <ContentTemplate>
                                                ...
                                                <div class="form-group pull-right"><label>Buscar:  </label></div>
                                                    <asp:Table ID="Table2" runat="server" CssClass="table table-hover table-bordered results">
                                                         <asp:TableHeaderRow runat="server">
                                                                ...
                                                                <asp:TableHeaderCell ColumnSpan="1">Descripción</asp:TableHeaderCell>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" style="text-align:center" id="exampleModalLabel">Nueva descripción de servicio</h4>
                                    </div>
                                    <div class="modal-body">
                                        <div class="container">
                                            <div class="pure-form pure-form-aligned">
                                                <fieldset class="pure-control-group">
                                                    <div class="input-prepend">
                                                        <label for="idarea">Identificador del la descripción</label>
                                                        <asp:TextBox ClientIDMode="Static" runat="server" MaxLength="20" ValidationGroup="Six" ReadOnly="true" ID="midArea" placeholder="D-001" data-toggle="tooltip" data-placement="right" title="En este espacio se debe proporcionar la descripción del activo que se desea registrar, es requerido. " />
                                                    ...
                                                    <div class="input-prepend">
                                                        ...
                                                        <asp:TextBox runat="server" ClientIDMode="Static" MaxLength="20" id="mDescripcion" ValidationGroup="Six" type="text" placeholder="Laptop" data-toggle="tooltip" data-placement="right" title="En este espacio se debe proporcionar la descripción del activo que se desea registrar, es requerido. " />
                                        ...
                                        <div class="modal-footer">
                                            <div class="span">
                                                <asp:Button runat="server" ValidationGroup="Six" CssClass="btn btn-primary" OnClick="Btn_modificar_areas_Click"  ID="Button1" Text="Modificar Descripción" />
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <asp:Button runat="server" Text="Inhabilitar" OnClick="Btn_inhabilitar_Click"  CssClass="btn btn-danger" ID="Btn_inhabilitar" ValidationGroup="five"  />
                                   </div>
                                </div>
                            </div>
                    </div> 
...
<%--            </ContentTemplate>
            ...
            <div class="modal fade" id="exampleModa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h1 class="modal-title" style="text-align:center" id="exampleModalLabe">Descripción Inhabilitada</h1>
                        </div>
                        <div class="modal-body">
                            <div class="container">
                               La descripción <b id="idA"></b> que está consultando, se encuentra inhabilitado en el sistema.
                                <br />
                                ...
                                <br />
                                <h3>¿Desea habilitar denuevo el Descripción?</h3>
                                </div>
                            </div> <!-- /container -->
                        <div class="modal-footer">
                            <img src="img/ExpediaLogo.png" alt="" style="width:50px; height:50px;float:left" />
                            <asp:Button runat="server" ID="btn_habilitarUsuario" OnClick="btn_habilitarUsuario_Click" Text="Si" CssClass="btn btn-danger" />
