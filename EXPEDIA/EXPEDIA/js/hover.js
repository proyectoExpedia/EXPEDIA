    ...
    var methods = {
        init: function (options) {
            var defaults = {
                ...
                overlay_width: 1000,		// The overlay element's width. Set to 0 to use the same as 'width'
                overlay_height: 1110,		// The overlay element's height. Set to 0 to use the same as 'height'
